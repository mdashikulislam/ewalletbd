                ...
                <table  class="table table-hover nowrap" style="width:100%">
                    ...
                    @foreach($documents as $document)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.document.user.approve.attempt',['id'=>$document->id])}}" class="btn btn-success approve" data-toggle="tooltip" title="Approve"><i class="fa fa-check"></i></a>
                                <a href="{{route('admin.document.user.delete',['id'=>$document->id])}}" class="btn btn-danger reject" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
